<x-main-layout>
    ...
    {{-- Page Header --}}
    <section class="relative h-64 bg-cover bg-center text-white flex items-center justify-center" style="background-image: url('https://source.unsplash.com/1600x900/?contact,phone');">
        <div class="absolute inset-0 bg-black opacity-50"></div>
        <div class="relative z-10 text-center px-4 fade-in">
            {{-- Menggunakan key JSON --}}
            <h1 class="text-4xl md:text-5xl font-bold">{{ __('contact.header.title') }}</h1>
            <p class="text-lg md:text-xl mt-2">{{ __('contact.header.description') }}</p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="fade-in">
                    ...
                    {{-- !! PERBAIKAN: Tambah locale ke route contact.submit !! --}}
