{{-- Lokasi File: resources/views/admin/explore-posts/create.blade.php --}}
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create New Explore Post') }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.explore-posts.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="explore_category_id" id="explore_category_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('explore_category_id') == $category->id ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <x-text-input id="title_en" class="block mt-1 w-full" type="text" name="title[en]" :value="old('title.en')" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="title_nl" class="block mt-1 w-full" type="text" name="title[nl]" :value="old('title.nl')" />
                            ...
                            <div>
                                ...
                                <x-text-input id="title_zh" class="block mt-1 w-full" type="text" name="title[zh]" :value="old('title.zh')" />
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="content_en" name="content[en]" class="tinymce-editor block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('content.en') }}</textarea>
                            ...
                            {{-- Konten (NL) --}}
                             <div class="mt-4">
                                ...
                                <textarea id="content_nl" name="content[nl]" class="tinymce-editor block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('content.nl') }}</textarea>
                             ...
                             <div class="mt-4">
                                ...
                                <textarea id="content_zh" name="content[zh]" class="tinymce-editor block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('content.zh') }}</textarea>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Max file size: 2MB. Allowed types: jpg, jpeg, png, webp.</p>
                            </div>
    ...
    @push('scripts')
    {{-- Pastikan path ini benar sesuai hasil `npm run build` --}}
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        tinymce.init({
          ...
          convert_urls : true,
          // content_style: 'body { font-family: Figtree, sans-serif; font-size:1rem }' // Sesuaikan font jika perlu
        });
      });
    </script>
    @endpush
